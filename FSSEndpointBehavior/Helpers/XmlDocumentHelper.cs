...
namespace Extensions
{
    ...
    internal static class XmlDocumentHelper
    {
        ...
        public static XmlDocument Decrypt(XmlDocument encryptedXmlDocument, X509Certificate2 insurerCertificate)
        {
            ...
            GostEncryptedXml gostEncryptedXml = new GostEncryptedXml(encryptedXmlDocument);
                    ...
                    if (encryptedKey != null)
                    {
                        foreach (object obj2 in encryptedKey.KeyInfo)
                        {
                            if (obj2 is KeyInfoX509Data)
                            {
                                ...
                                if (certificate.GetPrivateKeyAlgorithm() is GostAsymmetricAlgorithm privateKeyAlgorithm7)
                                {
                                    symmetricAlgorithm = GostEncryptedXml.DecryptKey(encryptedKey.CipherData.CipherValue, privateKeyAlgorithm7);
                                    break;
                                }
                            }
                        }
        ...
        public static XmlDocument Encrypt(XmlDocument xmlDocument, X509Certificate2 fssCertificate, X509Certificate2 insurerCertificate)
        {
            ...
            GostCryptography.Config.GostCryptoConfig.ProviderType = ProviderType.CryptoPro;
            GostCryptography.Config.GostCryptoConfig.ProviderType_2012_512 = ProviderType.CryptoPro_2012_512;
            GostCryptography.Config.GostCryptoConfig.ProviderType_2012_1024 = ProviderType.CryptoPro_2012_1024;
            GostEncryptedXml gostEncryptedXml = new GostEncryptedXml(ProviderType.CryptoPro);
            ...
            if (documentElement != null)
            {
                ...
                using (GostCryptography.Gost_28147_89.Gost_28147_89_SymmetricAlgorithm symmetricAlgorithm_orig = new GostCryptography.Gost_28147_89.Gost_28147_89_SymmetricAlgorithm(ProviderType.CryptoPro_2012_512))
                {
                    ...
                    encryptedKey.KeyInfo.AddClause(new KeyInfoX509Data(fssCertificate));
...
#pragma warning restore CS0612
        ...
        private static string GetSignatureMethod(X509Certificate2 certificate)
        {
            ...
            using (var publicKey = (GostAsymmetricAlgorithm)certificate.GetPublicKeyAlgorithm()) //TODO
            {
