...
using Extensions.SickList;
using Extensions;

namespace Extensions
{
    public class MessageSickList : FSSMessage
    {
        protected string RegNum { get; set; }
        public MessageSickList(Message _message, SickList.EndpointBehaviorSickList _endpoinBehavior) : base(_message, _endpoinBehavior) { }
    ...
    public class MessageSickListSet : MessageSickList
    {
        public MessageSickListSet(Message _message, SickList.EndpointBehaviorSickList _endpoinBehavior) : base(_message, _endpoinBehavior) { }
    ...
    public class MessageSickListGet : MessageSickList
    {
        public MessageSickListGet(Message _message, SickList.EndpointBehaviorSickList _endpoinBehavior) : base(_message, _endpoinBehavior) { }
