    ...
    class FSSMessageDirectPayments : FSSMessage
    {
        ...
        public override void Sign()
        {
            ...
            if (dataNode != null)
            {
                ...
                dataNode.InnerText = Convert.ToBase64String(signedData);
            }
        }
        ...
        public override void Encrypt()
        {
            ...
            if (dataNode != null)
            {
                ...
                dataNode.InnerText = Convert.ToBase64String(encryptedData);
            }
        }
        ...
        public override void Decrypt()
        {
            ...
            {
                string decryptedData = Convert.ToBase64String(ByteHelper.Decrypt(Convert.FromBase64String(fileTicketNode.InnerText)));
